...
public class UpdateBiodata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor = db.rawQuery("SELECT * FROM biodata WHERE table1 = '" +
                getIntent().getStringExtra("table1") + "'",null);
        cursor.moveToFirst();
        if (cursor.getCount()>0)
        {
            cursor.moveToPosition(1);
            table1.setText(cursor.getString(1).toString());
            table2.setText(cursor.getString(2).toString());
            table3.setText(cursor.getString(3).toString());
            table4.setText(cursor.getString(4).toString());
            table5.setText(cursor.getString(5).toString());
            table6.setText(cursor.getString(6).toString());
            table7.setText(cursor.getString(7).toString());
            table8.setText(cursor.getString(8).toString());
            table9.setText(cursor.getString(9).toString());
            table10.setText(cursor.getString(10).toString());
        ...
        btexport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                db.execSQL("update biodata set table1='"+
                        table1.getText().toString() +"', table2='" +
                        table2.getText().toString() +"', table3='" +
                        table3.getText().toString() +"', table4='" +
                        table4.getText().toString() +"', table5='" +
                        table5.getText().toString() +"', table6='" +
                        table6.getText().toString() +"', table7='" +
                        table7.getText().toString() +"', table8='" +
                        table8.getText().toString() +"', table9='" +
                        table9.getText().toString() +"', table10='" +
    ...
    @Override
    public boolean onCreateOpt        getMenuInflater().inflate(R.menu.main, menu);
        return true;
}
    ionsMenu(Menu menu) {
